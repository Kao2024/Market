...
public final class Service3Grpc {
  ...
  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "service3Do",
        ...
        if ((getService3DoMethod = Service3Grpc.getService3DoMethod) == null) {
          Service3Grpc.getService3DoMethod = getService3DoMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ...
                  .setSchemaDescriptor(new Service3MethodDescriptorSupplier("service3Do"))
                  .build();
          }
        }
     }
  ...
  private static final int METHODID_SERVICE3DO = 0;
